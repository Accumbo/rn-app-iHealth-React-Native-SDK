...
module.exports = {
  ...
  /**
   * Addition for initializing SDK when needed. Mainly to not present the user with permission pop-up at start
   */
  initializeSDK: function () {
    RCTModule.initializeSDK();
  },
